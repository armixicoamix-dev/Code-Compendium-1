...
const fa1: Round = {
  ...
  lesson: {
    ...
    sections: [
      ...
      {
        heading: "📝 Разбор упражнений: ответы и объяснения",
        tagline: "Читай эту секцию если застрял — здесь ответы на все задания раунда",
        body:
...
const fa4: Round = {
  ...
  lesson: {
    ...
    sections: [
      ...
      {
        heading: "📝 Разбор упражнений: ответы и объяснения",
        tagline: "Полные ответы на все задания раунда 4",
        body:
